...
- For IDL programmers:
  ...
  - down the idl ADI libs from [here](https://engineering.arm.gov/~gaustad/adi_idl_libs.1.0.tar.gz). 
...
- [Quick Reference Guide (under construction)] (https://engineering.arm.gov/~gaustad/adi_training_videos/adi_quickstart.htm)
