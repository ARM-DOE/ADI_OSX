...
*    $Revision: 60706 $
*    $Author: ermold $
*    $Date: 2015-03-09 23:08:19 +0000 (Mon, 09 Mar 2015) $
*
********************************************************************************
*
...
*/
    ...
    **********************************************************************/
    ...
    for (di = 0; di < ret_var->ndim_names; di++) {
 ...
 *  @return
 *    -  1 if successful
 *    -  0 if a required variable was not found
 *    - -1 if an error occurred
 */
    ...
    for (rvi = 0; rvi < ret_group->nvars; rvi++) {
        ...
        if (!found_var_flags[rvi] &&
            ...
            WARNING( DSPROC_LIB_NAME,
                "Could not find data for required variable: %s->%s\n",
 ...
 *    -  0 if a required variable could not be found for the requested
 *         processing interval.
 *    - -1 if an error occurred
 */
