...
*    $Revision: 55246 $
*    $Author: ermold $
*    $Date: 2014-06-20 21:01:28 +0000 (Fri, 20 Jun 2014) $
*
********************************************************************************
*
 ...
 *                           and storing data. Only observations that start
 *                           within the current processing interval will be
 *                           read in.
 *
 ...
 *  flag is 0 or reprocessing mode is enabled.
 *
 *  If an error occurs in this function it will be appended to the log and
 *  error mail messages, and the process status will be set appropriately.
 *
