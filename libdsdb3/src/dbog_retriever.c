 ...
 *  dimension order. The following macros can be used to access the collumn
 *  values for each row:
 *
 ...
 *  macros can be used to access the collumn values for each row:
 *
 ...
 *  priority. The following macros can be used to access the collumn values
 *  for each row:
 *
 ...
 *  subgroup order. The following macros can be used to access the collumn
 *  values for each row:
 *
 ...
 *
 *  The returned rows will be sorted by datastream group ID and then by
 *  variable ID. The following macros can be used to access the collumn
 *  values for each row:
 *
 ...
 *  order. The following macros can be used to access the collumn values
 *  for each row:
 *
 ...
 *  be used to access the collumn values for each row:
 *
